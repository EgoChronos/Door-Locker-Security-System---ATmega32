...
#define LCD_DATA_Command_PORT_ID 		   PORTA_ID
#define LCD_DATA_Command_FIRST_PIN_ID 		PIN3_ID

/*control LCD port*/
#define LCD_CONTROL_PORT_ID PORTA_ID
 ...
 * Display the required string on the screen
 */
void LCD_displayData(const uint8* ptr2Data, uint8 length);
